...
public class Skeleton : MonoBehaviour
{
    ...
    public void Start()
    {
        idle = Resources.Load<Sprite>("Sprites/Skeleton/SkeletonSprite");
        dead = Resources.Load<Sprite>("Sprites/Skeleton/SkeletonSpriteDead");
        ...
        prefabBullet = Resources.Load<GameObject>("Bullets/SkeletonBullet");
    ...
    void GunUpdate()
    {
        ...
        if (ableToShoot == true && this.GetComponent<Life>().dead != true)
        {
            ableToShoot = false;
